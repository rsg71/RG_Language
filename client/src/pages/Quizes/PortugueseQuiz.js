...
export default function PortugueseQuiz() {
    ...
    async function verifyAnswer(value, enterKeyPressed) {
        if (value === answer) {
            ...
            let res = await API.answerPortugueseCorrectly(currentWord._id);
    ...
    return (
        ...
        <>
            <Container >
                <DefaultBreadcrumb pageTitle="Portuguese Quiz" />
                ...
                {loaded && !error && !loading &&
                    <>
                        <Row>
                            <Col className="mb-3">
                                <Link to="/portuguese"><Button><i className="fas fa-arrow-circle-left"></i> Back</Button></Link>
                            </Col>
                        </Row>
